...
public class SelectLandForSaleApplyPlotFilterSaveSearch {
    ...
    String username = "coneivaulalli-5488@yopmail.com";
    String password = "12091997";
    ...
    public void expandFiltersApplyPlot() {
        ...
        driver.findElement(By.cssSelector("[data-testid='filters-button']")).click();
        //Select the plot option
        driver.findElement(By.cssSelector("[data-testid='building-type-option-plot-checkbox-message']")).click();
        //Apply the filter
        driver.findElement(By.cssSelector("[data-testid='more-filters-submit-button']")).click();
    }
    ...
    public void saveSearch() {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("[data-testid='save-search-btn']"))).click();
